<template>
  <div class="dialog-container">
    <el-dialog title="发放优惠券" v-model="isShowDialog" width="800px" :close-on-click-modal="false" :destroy-on-close="true">
        ...
        <el-row :gutter="35">
          ...
          <!-- <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
            <el-form-item label="发送数量">
              <el-input v-model="amount" placeholder="发送数量" clearable class="input100"></el-input>
            </el-form-item>
          </el-col> -->
...
import { batchGrantCoupons } from '@/api/coupons/index'
...
const { loading, coupon, amount, memberList, isShowDialog } = toRefs(state)
