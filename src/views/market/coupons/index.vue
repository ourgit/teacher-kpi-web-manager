    ...
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        ...
        <el-form-item label="优惠券名称">
          <el-input v-model="queryData.filter" placeholder="请输入优惠券名称">
            <template #append>
        ...
        <el-form-item>
          <router-link to="/market/coupons/add">
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="couponTitle" label="券标题" min-width="160" show-overflow-tooltip />
        <el-table-column label="图片" width="180">
          <template #default="{ row }">
            <img :src="row.imgUrl" class="image">
          </template>
        </el-table-column>
        <el-table-column prop="couponContent" label="券内容" show-overflow-tooltip />
        ...
        <el-table-column prop="expireDays" label="领后有效天数" width="120" show-overflow-tooltip align="center" />
        <el-table-column prop="claimLimitPerMember" label="每人限领数" width="120" show-overflow-tooltip align="center" />
        <el-table-column prop="totalAmount" label="总数" show-overflow-tooltip width="100" align="center" />
        <el-table-column fixed="right" label="操作" width="240">
          <template #default="{ row }">
            <router-link :to="`/market/coupons/edit?couponsId=${row.id}`" class="mr10">
