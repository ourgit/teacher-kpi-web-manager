  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        ...
        <el-form-item>
          <el-date-picker size="default" v-model="timeRange" type="monthrange" range-separator="至" start-placeholder="开始时间" end-placeholder="结束时间" format="YYYY-MM-DD" value-format="x" />
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="title" label="优惠券名称" width="150" show-overflow-tooltip />
        <el-table-column prop="title" label="数量" width="150" show-overflow-tooltip>
          <template #default="{ row }">
            {{ row.leftCount > 0 ? row.leftCount : 1 }}
          </template>
        </el-table-column>
...
import { mebmerCardList } from '@/api/market/card/index'
...
const downloadFile = () => {
  import('@/utils/export.js').then((excel) => {
    ...
    mebmerCardList({ page: 0, ...state.submitData }).then((data: any) => {
