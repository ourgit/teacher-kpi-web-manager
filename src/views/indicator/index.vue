    ...
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        ...
        <el-form-item label="指标名称">
          <el-input v-model="queryData.indicatorName" size="default" placeholder="请输入指标名称" clearable> </el-input>
        </el-form-item>
        <el-form-item label="指标附属名称">
          <el-input v-model="queryData.subName" size="default" placeholder="请输入指标附属名称" clearable> </el-input>
        </el-form-item>
        <el-form-item label="KPI">
          <el-select v-model="queryData.kpiId" size="default" placeholder="KPI标题" clearable>
            <el-option label="全部" :value="0" />
            <el-option v-for="item in kpiList" :key="item.id" :label="item.title" :value="item.id" />
          </el-select>
        </el-form-item>
        <el-form-item>
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="indicatorName" label="指标名称" style="text-align: center;"/>
        <el-table-column prop="subName" label="指标附属名称" style="text-align: center;"/>
...
const { list, loading, currentPage, totalPage, queryData, kpiList, totalBalance } = toRefs(state)
