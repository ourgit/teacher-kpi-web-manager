<template>
  <div class="dialog-container">
    <el-dialog title="添加指标" v-model="isShowDialog" width="500px" :close-on-click-modal="false" :destroy-on-close="true">
...
import { addIndicator } from '@/api/indicator/index'
