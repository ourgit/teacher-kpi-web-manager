<template>
  <div class="dialog-container">
    <el-dialog title="添加要素" v-model="isShowDialog" width="500px" :close-on-click-modal="false" :destroy-on-close="true">
...
import { addElement } from '@/api/element/index'
