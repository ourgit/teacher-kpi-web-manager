    ...
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true">
        ...
        <el-form-item label="评价要素">
          <el-input v-model="queryData.element" size="default" placeholder="请输入评价要素" clearable> </el-input>
        </el-form-item>
        ...
        <el-form-item label="指标">
          <el-select v-model="queryData.indicatorId" size="default" placeholder="" clearable>
            ...
            <el-option v-for="item in indicatorList" :key="item.id" :label="item.indicatorName" :value="item.id" />
          </el-select>
        </el-form-item>
        <el-form-item>
