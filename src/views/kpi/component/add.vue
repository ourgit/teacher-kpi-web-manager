<template>
  <div class="dialog-container">
    <el-dialog title="添加KPI" v-model="isShowDialog" width="500px" :close-on-click-modal="false" :destroy-on-close="true">
        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="KPI标题" prop="title">
              <el-input v-model="ruleForm.title" placeholder="请输入KPI标题" clearable></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
