  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        <el-table-column prop="name" label="取餐点名称" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="areaName" label="所属校区" show-overflow-tooltip>
        </el-table-column>
        <el-table-column prop="district" label="归属区域" show-overflow-tooltip>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200" fixed="right">
          <template #default="{ row }">
            <el-button size="small" text type="primary" @click="onOpenDeliveryFee(row.id)">配送费配置</el-button>
    ...
    <detailDialog ref="detailDialogRef" @refresh="getListData" @onAddSuccess="onOpenDeliveryFee" />
...
import { getRegionList, delRegion } from '@/api/base/region/index'
...
const onRowDel = (row: any) => {
  ElMessageBox.confirm(`您确定要删除此取餐点吗?`, '提示', {
