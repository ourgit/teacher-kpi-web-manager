        ...
        <el-row :gutter="35">
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="所属校区" prop="areaId">
              <el-select v-model="ruleForm.areaId" placeholder="选择所属校区" @change="getDistrictListData" filterable style="width: 100%;">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="归属区域" prop="district">
              <el-select v-model="ruleForm.district" placeholder="选择归属区域" filterable style="width: 100%;">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="排序" prop="sort">
              <el-input v-model="ruleForm.sort" placeholder="请输入排序,值越大越靠前" clearable></el-input>
            </el-form-item>
          </el-col>
...
import { addPlace, updatePlace, getPlaceDetail } from '@/api/base/place/index'
...
const state = reactive({
  ...
  rules: {
    ...
    district: [{ required: true, trigger: 'change', message: '请选择归属区域' }],
    name: [{ required: true, trigger: 'blur', message: '请填写存放点名称' }],
  },
  dialog: {
    isShowDialog: false,
    type: '',
