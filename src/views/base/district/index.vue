  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        <el-table-column prop="name" label="区域名" show-overflow-tooltip>
        </el-table-column>
...
import { getDistrictList, delDistrict } from '@/api/base/district/index'
...
const onRowDel = (row: any) => {
  ElMessageBox.confirm(`您确定要删除此区域吗?`, '提示', {
