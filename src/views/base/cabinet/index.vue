  ...
  <div class="page-container layout-padding">
    <el-card shadow="hover" class="layout-padding-auto">
      <el-form class="query" :inline="true" size="default" label-width="80px">
        <el-row>
          ...
          <el-form-item label="名称">
            <el-input v-model="queryData.name" size="default" placeholder="请输入名称" clearable> </el-input>
          </el-form-item>
          <el-form-item label="编号">
            <el-input v-model="queryData.cabinetSn" size="default" placeholder="请输入编号" clearable> </el-input>
          </el-form-item>
          <el-form-item>
      ...
      <el-table :data="list" v-loading="loading" style="width: 100%">
        ...
        <el-table-column prop="cabinetSn" label="编号" show-overflow-tooltip>
        </el-table-column>
...
import { getCabinetList, delCabinet } from '@/api/base/cabinet/index'
...
const onRowDel = (row: any) => {
  ElMessageBox.confirm(`您确定要删除此智能柜吗?`, '提示', {
