  ...
  <div class="layout-navbars-breadcrumb-user pr15" :style="{ flex: layoutUserFlexNum }">
    <!-- <el-dropdown :show-timeout="70" :hide-timeout="50" trigger="click" @command="onComponentSizeChange">
      <div class="layout-navbars-breadcrumb-user-icon">
        <i class="iconfont icon-font-size" title="组件大小"></i>
      </div>
      <template #dropdown>
        <el-dropdown-menu>
    ...
    <!-- <div class="layout-navbars-breadcrumb-user-icon" @click="onLayoutSetingClick">
      <i class="iconfont icon-pifu" title="布局配置"></i>
    </div> -->
    <div class="layout-navbars-breadcrumb-user-icon">
    ...
    <div class="layout-navbars-breadcrumb-user-icon mr10" @click="onScreenfullClick">
      <i class="iconfont" :title="state.isScreenfull ? '关全屏' : '开全屏'" :class="!state.isScreenfull ? 'icon-fullscreen' : 'icon-tuichuquanping'"></i>
    </div>
    <el-dropdown :show-timeout="70" :hide-timeout="50" @command="onHandleCommandClick">
      <span class="layout-navbars-breadcrumb-user-link">
        ...
        <img v-else src="@/assets/avatar.png" class="layout-navbars-breadcrumb-user-link-photo mr5" />
      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item command="/system/password">修改密码</el-dropdown-item>
